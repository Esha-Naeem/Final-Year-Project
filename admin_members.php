...
<h1 class="h3 mb-0 text-gray-800">Manage Register Requests</h1>
</div>
...
<tbody>
    ...
    $get_data = mysqli_query($db, "SELECT * FROM users WHERE role = 'user' AND status = 1 ");
        ...
        while($row = mysqli_fetch_assoc($get_data)){
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="admin_members_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
