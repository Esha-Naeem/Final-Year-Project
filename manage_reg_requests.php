...
<h1 class="h3 mb-0 text-gray-800">Manage <b>Student</b> Register Requests</h1>
</div>
...
<tbody>
    ...
    $get_data = mysqli_query($db, "SELECT * FROM users WHERE role = 'user' AND status = 0 ");
        ...
        while($row = mysqli_fetch_assoc($get_data)){
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="manage_reg_requests.php?approve=<?php echo $row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-check"></i></a>
                    <a href="manage_reg_requests.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
...
if(isset($_GET['delete'])){
    ...
    if($remove){
        header("Location: manage_reg_requests.php");
    }
