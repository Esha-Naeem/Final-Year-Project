...
<tbody>
    ...
    $get_data = mysqli_query($db, "SELECT * FROM users WHERE role = 'faculty' AND status = 1 ");
        ...
        while($row = mysqli_fetch_assoc($get_data)){
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="admin_members_fac.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
...
if(isset($_GET['delete'])){
    ...
    if($remove){
        header("Location: admin_members_fac.php");
    }
